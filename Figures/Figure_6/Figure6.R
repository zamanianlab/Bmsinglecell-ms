############
## FIG 6 Flow cytometry analysis for drug dose responses
############
...
#################
### Fig. 6a - Viability workflow (small graphic)
#################
Fig6a_diagram <- ggdraw() +
  draw_image(here("Figures/Figure_6/Fig6a_workflow.png"))



#################
### Fig. 6a - spectralflo contour plots of viability
#################
Fig6a_flow <- ggdraw() +
  draw_image(magick::image_read_pdf(here("Figures/Figure_6/viability_flowcytometry.pdf")))




################
### Fig. 6b - flow cytometry, cell viability over time
################
...
# combine the plots for the Fig6b panel
...
(Fig6b <- plot_grid(viability, legend, ncol = 2, rel_widths = c(1, .2), scale = c(1, 0.1), axis = "t", align = "hv") + theme(plot.margin = margin(0, 1, 0, 0, "cm")))
...
################
### Fig. 6c - drug dose response curves with IVM, LEV, AZS
################
...
################
### Fig. 6d - spectralflo contour plots of IVM response
################
Fig6d <- ggdraw() +
  draw_image(magick::image_read_pdf(here("Figures/Figure_6/ivermectin_flowcytometry.pdf")))



###############
### Fig. 6e - 10X utBM/tBM UMAP and IVM DEG volcano plot
###############
...
response <- readRDS(here("Figures/Figure_6/IVM_response.RDS"))
...
Figure_6 <- cowplot::plot_grid(row1, row2, row3, row4, nrow = 4, rel_widths = c(1, 1, 1,1), rel_heights = c(1, 0.85, 1,1.1))

ggsave(Figure_6, filename = here("Figures/Figure_6.pdf"), device = cairo_pdf, width = 8.5, height = 10)
